...
def write_results(prediction, num_classes, nms = True, nms_conf = 0.4):
    ...
    for ind in range(batch_size):
        ...
        #Get the class having maximum score, and the number of that class
        #Get rid of num_classes seperate scores 
        ...
        #Get the various classes detected in tge image
        ...
        for cls in img_classes:
            ...
            image_pred_class = image_pred_[class_mask_ind]
             ...
             #sort the detections such that the entry with the maximum class
